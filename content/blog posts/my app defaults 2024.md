...
📮 Mail Server: 如上。  
📝 Notes: Obsidian 是主力笔记软件和数字花园发布站点，~~TiddlyWiki 是个人维基发布站点，~~ 轻度使用 Notion 和 AnyType。  
...
📑 Read It Later: 如上。  
📜 Word Processing: 写作工具主要是 Obsidian，偶尔使用 Notion 和 AnyType 辅助，极端情况下使用 [[how i change about using pc|Notepad--]] 和记事本。  
...
⌨️ Text input: PC 端使用系统自带微软输入法，[[flypy|小鹤双拼]]，移动端使用 [Gboard](https://play.google.com/store/apps/details?id=com.google.android.inputmethod.latin) 和 vivo 输入法 Pro。  
...
除了以上 app 之外，在我国日常生活中还有许多平台类 app，如淘宝、滴滴、各类政务和银行 app 等等。有些做得很不错，有些就是一坨屎，但不得不用。当然[[my thoughts on wechat ten years|微信]]和钉钉是不得不用的两坨最大的屎。