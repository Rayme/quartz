...
直接了当表达出对同质化的所谓“数字花园”的厌倦，这些站点充斥着大量“如何建立数字花园”、“如何记笔记”、“如何建立第二大脑”诸如此类的生产力色情文章（为何我想到少数派上的某些文章？）。这句质问 what are you guys even using obsidian for if using it seems to be a goal in itself? 直抵核心，也是悬在我头上的警醒，它提醒我在任何情况下都要注意不要陷入生产力工具使用陷阱，不要把手段当作目的。

永远有比如何使用某一工具更加重要的事情。

那些从不把“笔记方法”放在首位的数字花园，才是真正个人的、有趣的、持续增长的站点。我本想点一些网站，不过这样显得太过攻击性，还是放一些我喜欢的数字花园为好。首先是这个帖子里出现过的：

- [Maggie Appleton's Garden](https://maggieappleton.com/)
- [mister chad](https://mister-chad.com/)
- [Mental Nodes](https://www.mentalnodes.com/)

第一个和第三个都鼎鼎大名。下面是我过去收藏过的合集。
...
- [Sine's Wiki](https://kiwi.ssine.cc/)
